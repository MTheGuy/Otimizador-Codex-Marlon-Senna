 ...
 * the same prefix: `/project/local-app/src/main/patch.ts` where `src/main/patch.ts`
 ...
 *
 * The workspace learned from `/project/local-app/src/main/patch.ts` should be the
...
export interface Workspace {
  /** Virtual path of the folder, e.g. `/project/local-app`. */
  virtual: string;
  real: string;
  at: number;
}
