...
export const TURN_OUTCOME_LABELS: Record<TurnOutcome, string> = {
  completed: 'concluído',
  failed: 'falhou com erro visível',
  stopped: 'interrompido pelo usuário',
  interrupted: 'interrompido antes de concluir',
  stalled: 'travado — sem progresso visível',
  unknown: 'encerrado por motivo desconhecido'
};
...
export const ATTRIBUTION_LABELS: Record<CallAttribution, string> = {
  request_id: 'identificador exato da chamada',
  unattributed: 'identificador da chamada não resolvido',
  superseded: 'conversa substituída',
  agent: 'chave do agente',
  turn: 'bloco de ferramenta na página',
  generation: 'única conversa gerando resposta',
  inferred: 'não associado a uma conversa'
};
