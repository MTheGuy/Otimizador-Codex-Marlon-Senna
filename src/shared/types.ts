...
export interface Config {
  ...
  readOnly: boolean;
  /** Revisão humana inicial; permissões efetivas continuam em capabilities/readOnly. */
  security?: { reviewed: boolean };
...
export const CAPABILITY_DETAILS: Record<Capability, string> = {
  browse: 'Listar o conteúdo das pastas aprovadas.',
  search: 'Localizar arquivos e pesquisar textos dentro dos projetos aprovados.',
  read: 'Ler textos e abrir imagens locais dos projetos aprovados.',
  metadata: 'Consultar tamanho, datas e quantidade de linhas, sem ler o conteúdo.',
  create: 'Adicionar arquivos e pastas dentro dos projetos aprovados.',
  edit: 'Alterar arquivos dentro dos projetos aprovados.',
  move: 'Mover ou renomear arquivos entre pastas aprovadas.',
  deleteFile: 'Excluir permanentemente arquivos dos projetos aprovados, sem usar a Lixeira.',
  command: 'Executar programas com o acesso da sua conta no sistema operacional. NÃO fica limitado aos projetos.',
  screen: 'Capturar a tela e observar janelas e controles, inclusive fora dos projetos.',
  control: 'Mover o mouse, clicar e digitar em aplicativos com o acesso da sua conta. NÃO fica limitado aos projetos.',
  clipboardRead: 'Ler o texto atual da área de transferência, que pode conter dados de outros aplicativos.',
  clipboardWrite: 'Substituir o texto da área de transferência do sistema.'
};
