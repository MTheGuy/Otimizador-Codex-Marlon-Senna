...
private func requireAccessibility() throws {
    ...
    guard AXIsProcessTrusted() else {
        throw fail(
            ...
            "ative Acessibilidade para este aplicativo (Controle de Dispositivos nas versões mais recentes do macOS); depois encerre completamente e reabra o aplicativo"
        )
    }
}
...
private func requireScreenCapture() throws {
    guard CGPreflightScreenCaptureAccess() else {
        ...
        throw fail(
            ...
            "ative Gravação de Tela para este aplicativo; depois encerre completamente e reabra o aplicativo"
        )
    }
}
